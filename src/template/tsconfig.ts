export default {
  compilerOptions: {
    ...
    noImplicitAny:
      false /* Raise error on expressions and declarations with an implied 'any' type. */,
    ...
    noImplicitThis:
      false /* Raise error on 'this' expressions with an implied 'any' type. */,
    ...
    experimentalDecorators:
      true /* Enables experimental support for ES7 decorators. */,
